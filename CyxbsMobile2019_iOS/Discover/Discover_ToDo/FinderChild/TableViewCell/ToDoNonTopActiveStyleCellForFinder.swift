...
/// 复用标志
let ToDoNonTopActiveStyleCellForFinderReuseIdentifier = "ToDoNonTopActiveStyleCellForFinder"

// 非置顶+未过期样式的cell
class ToDoNonTopActiveStyleCellForFinder: ToDoTableViewCellForFinder {
    ...
    override func layoutSubviews() {
        ...
        bellImgView.frame = CGRect(x: contentLab.left, y: contentLab.bottom + 1, width: 11, height: 13)
        timeLab.frame = CGRect(x: bellImgView.right + 6, y: contentLab.bottom, width: self.right - bellImgView.right - 8, height: 15.4)
    }
